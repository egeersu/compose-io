        ...
        return (
            <div className='PIS'>
                    ...
                    <div style={{textAlign:'center', width:'100%', alignItems: 'center', display: 'flex'}}>
                      <input name="Prolific ID" style={{fontSize:'1.5em', textAlign:'center', width:'50%'}} onChange={e=>props.setprolificID(e)}></input>
                    </div>
                    ...
                    <p className='consent-text3'><strong>Who are the researchers?</strong></p>
                  
                    <p className='consent-text2'><strong>Christopher G. Lucas</strong></p>
                    <p className='consent-text2'>Chancellor's Fellow/Lecturer, The University of Edinburgh, School of Informatics</p>

                    <p className='consent-text2'><strong>Simon Valentin</strong></p>
                    <p className='consent-text2'>PhD Student, The University of Edinburgh, School of Informatics</p>

                    <p className='consent-text2'><strong>Ege Ersü</strong></p>
                    <p className='consent-text2'>MSc Graduate, The University of Edinburgh, School of Informatics</p>

                                
                    <p className='consent-text2'></p>

                    <p className='consent-text3'><strong>What is the purpose of the study?</strong></p>
                    ...
                    <p className='consent-text3'><strong>Why have I been asked to take part?</strong></p>
                    <p className='consent-text2'>If you decide to take part, your crafting data will help us test our hypotheses.</p>

                    <p className='consent-text3'><strong> Do I have to take part?</strong></p>
                    ...
                    <p className='consent-text3'><strong>What will happen if I decide to take part?</strong></p>
                    ...
                    <p className='consent-text3'><strong>Are there any risks associated with taking part?</strong></p>
                    <p className='consent-text2'>There are no significant risks associated with participation.</p>
                    
                    <p className='consent-text3'><strong>Are there any benefits associated with taking part?</strong></p>
                    <p className='consent-text2'>There are no benefits associated with participation.</p>    

                    <p className='consent-text3'><strong>What will happen to the results of this study?</strong></p>
                    ...
                    <p className='consent-text3'><strong>Data protection and confidentiality.</strong></p>
                    ...
                    <p className='consent-text3'><strong>What are my data protection rights?</strong></p>
                    ...
                    <p className='consent-text3'><strong>Who can I contact?</strong></p>
                    ...
                    <p className='consent-text3'><strong>Updated information.</strong></p>
                    ...
                    <p className='consent-text3'><strong>Alternative Formats</strong></p>
    ...
    const page1 = () => {
        return (
            <div className='PIS'>
                    ...
                    <p className='consent-text2'> By clicking the START button you agree that:</p>
                    <p className='consent-text2'> (1) I have read and understood the Participant Information Sheet for this study, that I have had the opportunity to ask questions to the Principal Investigator via email, and that any questions I had were answered to my satisfaction.</p>
                    <p className='consent-text2'> (2) My participation is voluntary, and that I can withdraw at any time without giving a reason. Withdrawing will not affect any of my rights. </p>
                    <p className='consent-text2'> (3) I consent to my anonymised data being used in academic publications and presentations.  </p>
                    <p className='consent-text2'> (4) I am 18 years of age or older. </p>
                    <p className='consent-text2'> (5) I understand that my anonymised data will be stored for the duration outlined in the Participant Information Sheet. </p>
                    <p className='consent-text2'> (6) I allow my data to be used in future ethically approved research.</p>

                    <p className='consent-text2'> Title of Study: Studying Compositional Generalization in Virtual Environments </p>
                    <p className='consent-text2'> The experiment should take no longer than 10 minutes. </p>                
                    <p className='consent-text2'> Experimental Group: {props.group}</p>                           
            </div>
        )
    }
